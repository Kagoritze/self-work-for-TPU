'''
Создать программу для работы с базой данных. 
База данных должна содержать не менее 5 связанных таблиц. 
Реализовать вывод данных из созданной базы данных, запросы должны выбирать данные из нескольких таблиц. 
Допускается данные для разрабатываемой базы данных сгенерировать с помощью модуля «random», либо использовать из сторонних источников. 
Применить ООП стиль программирования.
'''
